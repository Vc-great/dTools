...
use deploy_commands::{deploy_with_config, get_deploy_status, cancel_deploy, DeployTasks};
...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .setup(|app| {
      ...
      // 添加���署任务管理器
      let deploy_tasks: DeployTasks = Arc::new(tokio::sync::Mutex::new(HashMap::new()));
      app.manage(deploy_tasks);
